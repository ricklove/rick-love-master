export const passageData = [
  ...
  },
  {
    book: `Exodus`,
    chapters: [
      22, 25, 22, 31, 23, 30, 25, 32, 35, 29, 10, 51, 22, 31, 27, 35, 16, 27, 25, 26, 36, 31, 33, 18, 40, 37, 21, 43,
  ...
  },
  {
    book: `1 Chronicles`,
    chapters: [
      54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 47, 40, 14, 17, 29, 43, 27, 17, 19, 8, 30, 18, 32, 31, 31, 32, 34, 21, 30,
    ],
  },
  {
    book: `2 Chronicles`,
  ...
  },
  {
    book: `Matthew`,
    chapters: [
      25, 23, 17, 25, 48, 34, 29, 34, 38, 42, 30, 49, 58, 36, 39, 28, 27, 34, 30, 34, 46, 46, 38, 51, 46, 75, 66, 20,
    ],
  },
  {
    book: `Mark`,
    chapters: [45, 28, 35, 41, 43, 56, 36, 38, 48, 52, 33, 44, 37, 72, 46, 20],
  },
  {
    book: `Luke`,
    chapters: [80, 52, 38, 44, 39, 49, 50, 56, 62, 42, 54, 59, 35, 35, 32, 31, 36, 43, 48, 47, 38, 71, 56, 53],
  },
  {
    book: `John`,
    chapters: [51, 25, 36, 54, 46, 71, 52, 59, 41, 42, 57, 50, 38, 31, 27, 33, 26, 40, 42, 31, 25],
  },
  {
    book: `Acts`,
    chapters: [
      26, 47, 26, 37, 42, 15, 60, 39, 43, 48, 30, 25, 52, 28, 40, 40, 34, 28, 41, 38, 40, 30, 35, 26, 27, 32, 44, 31,
    ],
  },
  {
    book: `Romans`,
    chapters: [32, 29, 31, 25, 20, 23, 25, 39, 33, 21, 36, 21, 14, 23, 33, 27],
  },
  {
    book: `1 Corinthians`,
