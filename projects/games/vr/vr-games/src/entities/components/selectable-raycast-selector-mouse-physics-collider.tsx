...
export type EntityRaycastSelectorMousePhysicsCollider = EntityRaycastSelector &
  EntityPhysicsView & {
    raycastSelectorMousePhysicsCollider: {
      // raycaster: Raycaster;
    };
    view: {
...
export const EntityRaycastSelectorMousePhysicsCollider = cloneComponent<EntityRaycastSelectorMousePhysicsCollider>()(
  EntityPhysicsView,
)
  .with(`raycastSelectorMousePhysicsCollider`, () => {
    return {
  ...
  .with(`view`, () => ({
    Component: (x) => (
      <EntityRaycastSelectorMousePhysicsColliderComponent
        entity={x.entity as EntityRaycastSelectorMousePhysicsCollider}
      />
    ),
  }));

export const EntityRaycastSelectorMousePhysicsColliderComponent = ({
  entity,
}: {
  entity: EntityRaycastSelectorMousePhysicsCollider;
}) => {
  ...
  // logger.log(`EntityRaycastSelectorMousePhysicsColliderComponent RENDER`, {});
