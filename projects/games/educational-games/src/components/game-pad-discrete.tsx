...
export const GamepadDiscrete = (props: {
    ...
    <View style={inputStyles.container}>
      <View style={inputStyles.section}>
        <View style={inputStyles.row}>
          ...
          <TouchableOpacity style={inputStyles.cellTouch} onPress={() => move({ x: 0, y: +1 })}>
            <View style={cellViewStyle}>
              <Text style={inputStyles.cellText}>⬆</Text>
            </View>
          </TouchableOpacity>
          <View style={inputStyles.cellEmptyView} />
        </View>
        <View style={inputStyles.row}>
          <TouchableOpacity style={inputStyles.cellTouch} onPress={() => move({ x: -1, y: 0 })}>
            <View style={cellViewStyle}>
              <Text style={inputStyles.cellText}>⬅</Text>
            </View>
          </TouchableOpacity>
        ...
        <View style={inputStyles.row}>
          {props.buttons.map((x) => (
            <React.Fragment key={`${x.text}`}>
              <View style={inputStyles.cellEmptyView} />
              <TouchableOpacity style={inputStyles.cellTouch} onPress={x.onPress}>
                <View style={cellViewStyle}>
                  <Text style={inputStyles.cellText}>{x.text}</Text>
                </View>
              </TouchableOpacity>
            </React.Fragment>
          ))}
