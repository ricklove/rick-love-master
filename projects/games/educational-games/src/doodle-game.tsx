...
import {
  ...
  DoodleGameView_ChooseBest,
  DoodleGameView_DrawWord,
  DoodleGameView_TypeExpected,
} from '@ricklove/doodle-client';
...
export const EducationalGame_Doodle = (props: {
  problemService: DoodleProblemService;
  drawingStorage: DoodleDrawingStorageService;
}) => {
...
export const EducationalGame_Doodle_Inner = (props: {
  problemService: DoodleProblemService;
  drawingStorage: DoodleDrawingStorageService;
  problemSourceKey: number;
}) => {
