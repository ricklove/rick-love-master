...
export const CodeWrapper_Zoom = (props: { children: ReactNode }) => {
  ...
  useEffect(() => {
    const { onMouseDown, onMouseUp, onMouseMove } = mouseEvents.current;

    const unsub = globalState.subscribe(() => {
      setScale(globalState.scale);
    });
  ...
  return (
    <div className='code-wrapper'>
      ...
      <div
        style={{ position: `absolute`, top: 4, right: 32, height: 8, width: ZOOM_SIZE, backgroundColor: `#FF0000` }}
        role='button'
        tabIndex={0}
        ref={zoomElement}
