...
type AddInventoryItem<TGS, TNewInventoryItem> = TGS extends InventoryContainer<infer TOldInventory>
  ? Omit<TGS, 'inventory'> & InventoryContainer<TOldInventory & TNewInventoryItem>
  : never;
type RemoveInventoryItem<TGS, TInventoryItemToRemove extends string> = TGS extends InventoryContainer<
  infer TOldInventory
>
  ? Omit<TGS, 'inventory'> & InventoryContainer<Omit<TOldInventory, TInventoryItemToRemove>>
  : never;
...
type EnvelopeInventory<T> = AddInventoryItem<
  Omit<T, 'openMailbox'>,
  {
    /** ### Old Envelope
     *
...
type LetterInventory<T> = AddInventoryItem<
  RemoveInventoryItem<T, 'envelope'>,
  {
    /** ### Old Letter
     *
