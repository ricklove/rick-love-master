 ...
 * https://ricklove.me/typescript-type-system-adventure
 */
const gameStart = null as unknown as GameState<
  HideType<{ _hasStarted: false; _location: ''; _inventory: {}; _environment: {} }>
>;
...
type SetInventory<T extends GameStateCommon, TNew> = Omit<T, '_inventory'> & {
  _inventory: Omit<T['_inventory'], keyof TNew> & TNew;
};
type SetEnvironment<T extends GameStateCommon, TNew> = Omit<T, '_environment'> & {
  _environment: Omit<T['_environment'], keyof TNew> & TNew;
};
...
type GameState_Environment<T extends GameStateCommon> =
  ...
  T extends { _hasStarted: false }
    ? T & {
         ...
         */
        begin: () => GameState<
          Omit<T, '_hasStarted' | '_location'> & { _location: 'InFrontOfHouse'; _inventory: {}; _environment: {} }
        >;
      }
    : // In Front of House ---
    T extends GameStateCommon<'InFrontOfHouse', {}, { isMailboxOpen?: false }>
    ? T & {
        /** ### In Front of House
         *
    ...
    : T extends GameStateCommon<'InFrontOfHouse', { letter?: false }, { isMailboxOpen: true }>
    ? T & {
        /** ### In Front of House
         *
         * You are in front of an old house.
    ...
    : T extends GameStateCommon<'InFrontOfHouse', { letter: true }, {}>
    ? T & {
        /** ### In Front of House
         *
         * You are in front of an old house.
    ...
    : // OutsideOldHouse ---
    T extends GameStateCommon<'OutsideOldHouse', {}, {}>
    ? T & {
        /** ### Outside Old House
         *
...
type GameState_Inventory<T extends GameStateCommon> = T extends { _inventory: { envelop: true } }
  ? {
      /** ### Open Envelope
       *
...
type GameState<T extends GameStateCommon> = T extends { youAreDead: true }
  ? GameOver
