...
export const LessonView_PreviewResult = ({
  data,
  onDone,
  setProjectState,
}: {
...
export const LessonView_ExperimentCode = ({
  data,
  onDone,
  setProjectState,
}: {
  ...
  const changeExperiment = (value: null | LessonExperiment) => {
    ...
    setModifiedProjectState((s) =>
      lessonExperiments_createReplacementProjectState(data.projectState, value.replacements),
    );
    ...
    const lengthDelta = lengthDeltas.reduce((out, x) => {
      out += x;
      return out;
    }, 0);
            ...
            <View
              style={
                activeExperiment === null
                  ? experimentStyles.experimentItemView_active
                  : experimentStyles.experimentItemView
              }
            >
