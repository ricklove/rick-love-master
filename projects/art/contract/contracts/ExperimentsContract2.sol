...
// ^-- Move to Solidity Function
            ...
            function writeOutput_text(iTextStart) {
                ...
                for { let iText := iTextStart } true { iText := add(1, iText) } {
                    let t := and(0xff, mload(add(
                        mload(add(mload(0x40),0x80)), // DataPack[text]
                        iText)))
        ...
        mstore(add(mload(0x40),0x60), add(mload(add(mload(0x40),0x20)), 0))
        mstore(add(mload(0x40),0x40), add(mload(add(mload(0x40),0x20)), 423))
        mstore(add(mload(0x40),0x80), add(mload(add(mload(0x40),0x20)), 1251))
