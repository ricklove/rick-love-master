...
// ^-- Move to Solidity Function
        ...
        function generateSvgInner() {
            ...
            writeOutput_text(0)
            writeOutput_color(getColor_bits(0x00, loadMemoryWord(26)))
            ...
            slot1 := ternary(slot0, getColor_bits(0x20, loadMemoryWord(26)), getColor_bits(0x28, loadMemoryWord(26)))
            writeOutput_color(ternary(and(getFieldData_bitFlag(0x03, loadMemoryWord(28)), not(mload(add(pVars, 0xa0)))), getColor_bits(0x08, loadMemoryWord(26)), slot1))
            writeOutput_text(365)
            slot2 := getBreedData_f_calico(mload(add(pVars, 0x0280)))
            writeOutput_color(ternary(and(getFieldData_bitFlag(0x00, loadMemoryWord(29)), not(slot2)), getColor_bits(0x18, loadMemoryWord(26)), slot1))
            writeOutput_text(435)
            writeOutput_color(slot1)
            writeOutput_text(505)
            slot3 := ternary(slot0, getColor_bits(0x28, loadMemoryWord(26)), getColor_bits(0x20, loadMemoryWord(26)))
            writeOutput_color(slot3)
            writeOutput_text(575)
            slot4 := ternary(slot2, slot1, slot3)
            writeOutput_color(slot4)
            writeOutput_text(645)
            slot0 := ternary(and(getFieldData_bitFlag(0x03, loadMemoryWord(28)), mload(add(pVars, 0xa0))), getColor_bits(0x08, loadMemoryWord(26)), slot1)
            writeOutput_color(ternary(and(getFieldData_bitFlag(0x03, loadMemoryWord(28)), slot2), slot0, slot3))
            writeOutput_text(715)
            writeOutput_color(slot0)
            writeOutput_text(785)
            writeOutput_color(ternary(and(getFieldData_bitFlag(0x00, loadMemoryWord(29)), slot2), getColor_bits(0x18, loadMemoryWord(26)), slot1))
            writeOutput_text(855)
            writeOutput_color(ternary(and(getFieldData_bitFlag(0x00, loadMemoryWord(29)), slot2), getColor_bits(0x18, loadMemoryWord(26)), slot3))
            writeOutput_text(926)
            writeOutput_color(0x01000080)
            writeOutput_text(997)
            writeOutput_color(ternary(slot2, ternary(getFieldData_bitFlag(0x07, loadMemoryWord(29)), getColor_bits(0x30, loadMemoryWord(26)), slot4), slot3))
            writeOutput_text(1068)
            writeOutput_color(ternary(slot2, ternary(getFieldData_bitFlag(0x06, loadMemoryWord(29)), getColor_bits(0x30, loadMemoryWord(26)), slot1), slot1))
            writeOutput_text(1139)
            writeOutput_color(getColor_bits(0x38, loadMemoryWord(26)))
            writeOutput_text(1210)
            slot0 := slt(getRvsValue(0x0e), 0x80)
            writeOutput_color(ternary(slot0, getColor(selectData_eyeColor(loadMemoryWord(27))), getColor(selectData_eyeColor(loadMemoryWord(27)))))
            writeOutput_text(1281)
            writeOutput_color(ternary(slot0, getColor(selectData_eyeColor(loadMemoryWord(27))), getColor(selectData_eyeColor(loadMemoryWord(27)))))
            writeOutput_text(1352)
            writeOutput_color(getColor_bits(0x40, loadMemoryWord(26)))
            writeOutput_text(1423)
            slot0 := getBreedData_f_zombieEyes(mload(add(pVars, 0x0280)))
            writeOutput_color(ternary(slot0, 0, 0xffffff))
            writeOutput_text(1494)
            writeOutput_color(ternary(slot0, 0xffffff, 0xffffff00))
            writeOutput_text(1565)
            writeOutput_color(0x333333)
            writeOutput_text(1627)
            writeOutput_color(getColor_bits(0x58, loadMemoryWord(26)))
            writeOutput_text(1565)
            writeOutput_color(0xdb7093)
            writeOutput_text(1565)
            writeOutput_color(0xe38fab)
            writeOutput_text(1698)
            writeOutput_color(getColor_bits(0x48, loadMemoryWord(26)))
            writeOutput_text(1769)
            writeOutput_color(getColor_bits(0x50, loadMemoryWord(26)))
            writeOutput_text(1840)
            writeOutput_color(getColor_bits(0x60, loadMemoryWord(26)))
            writeOutput_text(1565)
            writeOutput_color(0x505050)
            writeOutput_text(1911)
            slot1 := average(getFieldData_byte(0x20, loadMemoryWord(20)), getFieldData_byte(0x28, loadMemoryWord(20)))
            slot0 := sdiv(sdiv(mul(getFieldData_sub_bits(100, 8, 0x40, loadMemoryWord(20)), sub(slot1, getFieldData_byte(0x20, loadMemoryWord(20)))), 0x64), sub(0, getFieldData_byte(0x18, loadMemoryWord(20))))
            mstore(add(pVars, 0x02e0), average(getFieldData_byte(0x18, loadMemoryWord(20)), add(average(getFieldData_byte(0x18, loadMemoryWord(20)), 0), mul(slot0, sub(getFieldData_byte(0x28, loadMemoryWord(20)), getFieldData_byte(0x20, loadMemoryWord(20)))))))
            mstore(add(pVars, 0x02c0), sdiv(mul(getFieldData_byte(0x48, loadMemoryWord(20)), getFieldData_byte(0x18, loadMemoryWord(20))), 0x64))
            slot3 := bezierPoint_100(getFieldData_byte(0x18, loadMemoryWord(20)), mload(add(pVars, 0x02e0)), mload(add(pVars, 0x02c0)), 0, getFieldData_byte(0x50, loadMemoryWord(20)))
            writeOutput_int(sub(0, add(slot3, 0x0a)))
            writeOutput_text(2708)
            mstore(add(pVars, 0x02a0), average(getFieldData_byte(0x20, loadMemoryWord(20)), sub(slot1, mul(slot0, sub(0, getFieldData_byte(0x18, loadMemoryWord(20)))))))
            mstore(add(pVars, 0xa0), bezierPoint_100(getFieldData_byte(0x20, loadMemoryWord(20)), mload(add(pVars, 0x02a0)), getFieldData_byte(0x28, loadMemoryWord(20)), getFieldData_byte(0x28, loadMemoryWord(20)), getFieldData_byte(0x50, loadMemoryWord(20))))
            slot0 := sub(mload(add(pVars, 0xa0)), 0x32)
            writeOutput_int(slot0)
            writeOutput_text(2710)
            ...
            writeOutput_text(2708)
            writeOutput_int(slot0)
            writeOutput_text(2712)
            writeOutput_int(ternary(getFieldData_bitFlag(0x04, loadMemoryWord(28)), 0, 0x01))
            writeOutput_text(2837)
            slot1 := lerp_100(0x32, 0, getFieldData_byte(0x50, loadMemoryWord(20)))
            ...
            writeOutput_text(2908)
            writeOutput_int(ternary(getFieldData_bitFlag(0x03, loadMemoryWord(28)), 0, 0x01))
            writeOutput_text(3141)
            slot1 := lerp_100(slot3, add(slot3, 0x1e), lerp_100(0x28, 0x0a, getFieldData_byte(0x50, loadMemoryWord(20))))
            writeOutput_int(sub(0, slot1))
            writeOutput_text(2708)
            slot0 := lerp_100(mload(add(pVars, 0xa0)), add(mload(add(pVars, 0xa0)), 0x96), lerp_100(0x28, 0x0a, getFieldData_byte(0x50, loadMemoryWord(20))))
            writeOutput_int(slot0)
            writeOutput_text(2710)
            ...
            writeOutput_text(2708)
            writeOutput_int(slot2)
            writeOutput_text(3213)
            writeOutput_int(ternary(getFieldData_bitFlag(0x00, loadMemoryWord(28)), 0, 0x01))
            writeOutput_text(3234)
            writeOutput_int(sub(sub(0, add(slot3, sdiv(mul(mul(sub(0x01, sdiv(getFieldData_byte(0x50, loadMemoryWord(20)), 0x64)), 0x2a), 0x1e), 0x64))), 0x1a))
            writeOutput_text(2708)
            writeOutput_int(sub(add(mload(add(pVars, 0xa0)), sdiv(mul(mul(sub(0x01, sdiv(getFieldData_byte(0x50, loadMemoryWord(20)), 0x64)), 0x2a), 0x96), 0x64)), 0x14))
            writeOutput_text(3307)
            writeOutput_int(ternary(getFieldData_bitFlag(0x02, loadMemoryWord(28)), 0, 0x01))
            writeOutput_text(3579)
            slot0 := lerp_100(0x46, 0, getFieldData_byte(0x50, loadMemoryWord(20)))
            writeOutput_int(sub(0, add(slot3, slot0)))
            writeOutput_text(2708)
            writeOutput_int(mload(add(pVars, 0xa0)))
            writeOutput_text(3614)
            ...
            writeOutput_text(3213)
            writeOutput_int(ternary(getFieldData_bitFlag(0x01, loadMemoryWord(28)), 0, 0x01))
            writeOutput_text(3616)
            writeOutput_int(sdiv(lerp_100(0x64, 0x32, getFieldData_byte(0x50, loadMemoryWord(20))), 0x02))
            writeOutput_text(3670)
            writeOutput_int(ternary(slt(getRvsValue(0x0a), 0x80), 0x01, sub(0, 0x01)))
            writeOutput_text(3921)
            slot1 := average(getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20)), getFieldData_sub_bits(30, 8, 0x10, loadMemoryWord(20)))
            slot0 := sdiv(sub(slot1, getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20))), sub(getFieldData_byte(0x08, loadMemoryWord(20)), 0))
            mstore(add(pVars, 0x0220), sdiv(mul(getFieldData_byte(0x08, loadMemoryWord(20)), 0x04), 0x0a))
            mstore(add(pVars, 0x0200), average(getFieldData_byte(0x08, loadMemoryWord(20)), add(average(0, getFieldData_byte(0x08, loadMemoryWord(20))), mul(slot0, sub(getFieldData_sub_bits(30, 8, 0x10, loadMemoryWord(20)), getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20)))))))
            mstore(add(pVars, 0x01e0), average(getFieldData_sub_bits(30, 8, 0x10, loadMemoryWord(20)), sub(slot1, mul(slot0, sub(getFieldData_byte(0x08, loadMemoryWord(20)), 0)))))
            mstore(add(pVars, 0x01c0), bezierPoint_100(0, mload(add(pVars, 0x0220)), mload(add(pVars, 0x0200)), getFieldData_byte(0x08, loadMemoryWord(20)), getFieldData_byte(0x00, loadMemoryWord(21))))
            mstore(add(pVars, 0x01a0), bezierPoint_100(getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20)), getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20)), mload(add(pVars, 0x01e0)), getFieldData_sub_bits(30, 8, 0x10, loadMemoryWord(20)), getFieldData_byte(0x00, loadMemoryWord(21))))
            writeOutput(vertex(mload(add(pVars, 0x01c0)), mload(add(pVars, 0x01a0))))
            mstore(add(pVars, 0x0180), bezierPoint_100(getFieldData_byte(0x08, loadMemoryWord(20)), mload(add(pVars, 0x0200)), mload(add(pVars, 0x0220)), 0, getFieldData_byte(0x58, loadMemoryWord(20))))
            mstore(add(pVars, 0x0160), bezierPoint_100(getFieldData_sub_bits(30, 8, 0x10, loadMemoryWord(20)), mload(add(pVars, 0x01e0)), getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20)), getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20)), getFieldData_byte(0x58, loadMemoryWord(20))))
            mstore(add(pVars, 0xc0), add(mload(add(pVars, 0x0180)), getFieldData_sub_bits(41, 8, 0x08, loadMemoryWord(21))))
            mstore(add(pVars, 0x0140), sub(mload(add(pVars, 0x0160)), getFieldData_byte(0x10, loadMemoryWord(21))))
            mstore(add(pVars, 0xa0), lerp_100(mload(add(pVars, 0xc0)), mload(add(pVars, 0x01c0)), add(getFieldData_byte(0x18, loadMemoryWord(21)), sdiv(sdiv(mul(mul(ceil_100(getFieldData_byte(0x18, loadMemoryWord(21))), sub(0x50, getFieldData_byte(0x18, loadMemoryWord(21)))), sub(0, constrain(getFieldData_sub_bits(50, 8, 0x20, loadMemoryWord(21)), sub(0, 0x64), 0))), 0x64), 0x64))))
            slot2 := lerp_100(mload(add(pVars, 0x0140)), mload(add(pVars, 0x01a0)), add(getFieldData_byte(0x18, loadMemoryWord(21)), sdiv(sdiv(mul(mul(ceil_100(getFieldData_byte(0x18, loadMemoryWord(21))), sub(0x50, getFieldData_byte(0x18, loadMemoryWord(21)))), sub(0, constrain(getFieldData_sub_bits(50, 8, 0x20, loadMemoryWord(21)), sub(0, 0x64), 0))), 0x64), 0x64)))
            slot1 := add(average(mload(add(pVars, 0x01c0)), mload(add(pVars, 0xa0))), sdiv(mul(getFieldData_sub_bits(4, 8, 0x28, loadMemoryWord(21)), sub(slot2, mload(add(pVars, 0x01a0)))), 0x64))
            slot0 := sub(average(mload(add(pVars, 0x01a0)), slot2), sdiv(mul(getFieldData_sub_bits(4, 8, 0x28, loadMemoryWord(21)), sub(mload(add(pVars, 0xa0)), mload(add(pVars, 0x01c0)))), 0x64))
            ...
            slot3 := lerp_100(mload(add(pVars, 0xc0)), mload(add(pVars, 0x0180)), add(getFieldData_byte(0x18, loadMemoryWord(21)), sdiv(sdiv(mul(mul(ceil_100(getFieldData_byte(0x18, loadMemoryWord(21))), sub(0x50, getFieldData_byte(0x18, loadMemoryWord(21)))), constrain(getFieldData_sub_bits(50, 8, 0x20, loadMemoryWord(21)), 0, 0x64)), 0x64), 0x64)))
            slot0 := lerp_100(mload(add(pVars, 0x0140)), mload(add(pVars, 0x0160)), add(getFieldData_byte(0x18, loadMemoryWord(21)), sdiv(sdiv(mul(mul(ceil_100(getFieldData_byte(0x18, loadMemoryWord(21))), sub(0x50, getFieldData_byte(0x18, loadMemoryWord(21)))), constrain(getFieldData_sub_bits(50, 8, 0x20, loadMemoryWord(21)), 0, 0x64)), 0x64), 0x64)))
            slot4 := add(average(mload(add(pVars, 0xa0)), slot3), sdiv(mul(getFieldData_byte(0x30, loadMemoryWord(21)), sub(slot0, slot2)), 0x64))
            slot1 := sub(average(slot2, slot0), sdiv(mul(getFieldData_byte(0x30, loadMemoryWord(21)), sub(slot3, mload(add(pVars, 0xa0)))), 0x64))
            ...
            slot2 := add(average(slot3, mload(add(pVars, 0x0180))), sdiv(mul(getFieldData_sub_bits(24, 8, 0x38, loadMemoryWord(21)), sub(mload(add(pVars, 0x0160)), slot0)), 0x64))
            slot1 := sub(average(slot0, mload(add(pVars, 0x0160))), sdiv(mul(getFieldData_sub_bits(24, 8, 0x38, loadMemoryWord(21)), sub(mload(add(pVars, 0x0180)), slot3)), 0x64))
            ...
            writeOutput_text(3992)
            mstore(add(pVars, 0xa0), lerp_100(mload(add(pVars, 0x01c0)), mload(add(pVars, 0x0180)), getFieldData_byte(0x48, loadMemoryWord(21))))
            slot2 := lerp_100(mload(add(pVars, 0x01a0)), mload(add(pVars, 0x0160)), getFieldData_byte(0x48, loadMemoryWord(21)))
            writeOutput(vertex(mload(add(pVars, 0xa0)), slot2))
            mstore(add(pVars, 0x0100), lerp_100(mload(add(pVars, 0x01c0)), mload(add(pVars, 0x0180)), sub(0x64, getFieldData_byte(0x58, loadMemoryWord(21)))))
            mstore(add(pVars, 0xe0), lerp_100(mload(add(pVars, 0x01a0)), mload(add(pVars, 0x0160)), sub(0x64, getFieldData_byte(0x58, loadMemoryWord(21)))))
            ...
            mstore(add(pVars, 0xc0), add(lerp_100(mload(add(pVars, 0x0260)), mload(add(pVars, 0xc0)), getFieldData_byte(0x50, loadMemoryWord(21))), sdiv(getFieldData_sub_mul_bits(405, 4, 8, 0x60, loadMemoryWord(21)), 0x64)))
            mstore(add(pVars, 0x0120), lerp_100(mload(add(pVars, 0x0240)), mload(add(pVars, 0x0140)), getFieldData_byte(0x50, loadMemoryWord(21))))
            slot3 := lerp_100(mload(add(pVars, 0xc0)), mload(add(pVars, 0xa0)), add(getFieldData_byte(0x18, loadMemoryWord(21)), sdiv(sdiv(mul(mul(ceil_100(getFieldData_byte(0x18, loadMemoryWord(21))), sub(0x50, getFieldData_byte(0x18, loadMemoryWord(21)))), sub(0, constrain(getFieldData_sub_bits(50, 8, 0x20, loadMemoryWord(21)), sub(0, 0x64), 0))), 0x64), 0x64)))
            slot4 := lerp_100(mload(add(pVars, 0x0120)), slot2, add(getFieldData_byte(0x18, loadMemoryWord(21)), sdiv(sdiv(mul(mul(ceil_100(getFieldData_byte(0x18, loadMemoryWord(21))), sub(0x50, getFieldData_byte(0x18, loadMemoryWord(21)))), sub(0, constrain(getFieldData_sub_bits(50, 8, 0x20, loadMemoryWord(21)), sub(0, 0x64), 0))), 0x64), 0x64)))
            slot1 := add(average(mload(add(pVars, 0xa0)), slot3), sdiv(mul(getFieldData_sub_bits(4, 8, 0x28, loadMemoryWord(21)), sub(slot4, slot2)), 0x64))
            slot0 := sub(average(slot2, slot4), sdiv(mul(getFieldData_sub_bits(4, 8, 0x28, loadMemoryWord(21)), sub(slot3, mload(add(pVars, 0xa0)))), 0x64))
            ...
            slot2 := lerp_100(mload(add(pVars, 0xc0)), mload(add(pVars, 0x0100)), add(getFieldData_byte(0x18, loadMemoryWord(21)), sdiv(sdiv(mul(mul(ceil_100(getFieldData_byte(0x18, loadMemoryWord(21))), sub(0x50, getFieldData_byte(0x18, loadMemoryWord(21)))), constrain(getFieldData_sub_bits(50, 8, 0x20, loadMemoryWord(21)), 0, 0x64)), 0x64), 0x64)))
            slot0 := lerp_100(mload(add(pVars, 0x0120)), mload(add(pVars, 0xe0)), add(getFieldData_byte(0x18, loadMemoryWord(21)), sdiv(sdiv(mul(mul(ceil_100(getFieldData_byte(0x18, loadMemoryWord(21))), sub(0x50, getFieldData_byte(0x18, loadMemoryWord(21)))), constrain(getFieldData_sub_bits(50, 8, 0x20, loadMemoryWord(21)), 0, 0x64)), 0x64), 0x64)))
            mstore(add(pVars, 0xc0), add(average(slot3, slot2), sdiv(mul(getFieldData_sub_bits(34, 8, 0x40, loadMemoryWord(21)), sub(slot0, slot4)), 0x64)))
            slot1 := sub(average(slot4, slot0), sdiv(mul(getFieldData_sub_bits(34, 8, 0x40, loadMemoryWord(21)), sub(slot2, slot3)), 0x64))
            ...
            slot3 := add(average(slot2, mload(add(pVars, 0x0100))), sdiv(mul(getFieldData_sub_bits(24, 8, 0x38, loadMemoryWord(21)), sub(mload(add(pVars, 0xe0)), slot0)), 0x64))
            slot1 := sub(average(slot0, mload(add(pVars, 0xe0))), sdiv(mul(getFieldData_sub_bits(24, 8, 0x38, loadMemoryWord(21)), sub(mload(add(pVars, 0x0100)), slot2)), 0x64))
            ...
            writeOutput_text(4273)
            writeOutput(vertex(0, getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20))))
            writeOutput(bezierVertex(mload(add(pVars, 0x0220)), getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20)), mload(add(pVars, 0x0200)), mload(add(pVars, 0x01e0)), getFieldData_byte(0x08, loadMemoryWord(20)), getFieldData_sub_bits(30, 8, 0x10, loadMemoryWord(20))))
            slot1 := average(getFieldData_byte(0x08, loadMemoryWord(20)), getFieldData_byte(0x18, loadMemoryWord(20)))
            slot2 := average(getFieldData_sub_bits(30, 8, 0x10, loadMemoryWord(20)), getFieldData_byte(0x20, loadMemoryWord(20)))
            slot0 := sdiv(getFieldData_sub_bits(60, 8, 0x30, loadMemoryWord(20)), 0x64)
            slot3 := add(slot1, mul(slot0, sub(getFieldData_byte(0x20, loadMemoryWord(20)), getFieldData_sub_bits(30, 8, 0x10, loadMemoryWord(20)))))
            slot4 := sub(slot2, mul(slot0, sub(getFieldData_byte(0x18, loadMemoryWord(20)), getFieldData_byte(0x08, loadMemoryWord(20)))))
            slot1 := sub(slot1, mul(slot0, sub(getFieldData_byte(0x20, loadMemoryWord(20)), getFieldData_sub_bits(30, 8, 0x10, loadMemoryWord(20)))))
            slot0 := add(slot2, mul(slot0, sub(getFieldData_byte(0x18, loadMemoryWord(20)), getFieldData_byte(0x08, loadMemoryWord(20)))))
            mstore(add(pVars, 0xa0), average(getFieldData_byte(0x08, loadMemoryWord(20)), lerp_100(slot3, slot1, getFieldData_byte(0x38, loadMemoryWord(20)))))
            slot2 := average(getFieldData_sub_bits(30, 8, 0x10, loadMemoryWord(20)), lerp_100(slot4, slot0, getFieldData_byte(0x38, loadMemoryWord(20))))
            slot1 := average(getFieldData_byte(0x18, loadMemoryWord(20)), lerp_100(slot1, slot3, 0x64))
            slot0 := average(getFieldData_byte(0x20, loadMemoryWord(20)), lerp_100(slot0, slot4, 0x64))
            writeOutput(bezierVertex(mload(add(pVars, 0xa0)), slot2, slot1, slot0, getFieldData_byte(0x18, loadMemoryWord(20)), getFieldData_byte(0x20, loadMemoryWord(20))))
            writeOutput(bezierVertex(mload(add(pVars, 0x02e0)), mload(add(pVars, 0x02a0)), mload(add(pVars, 0x02c0)), getFieldData_byte(0x28, loadMemoryWord(20)), 0, getFieldData_byte(0x28, loadMemoryWord(20))))
            writeOutput(bezierVertex(sub(0, mload(add(pVars, 0x02c0))), getFieldData_byte(0x28, loadMemoryWord(20)), sub(0, mload(add(pVars, 0x02e0))), mload(add(pVars, 0x02a0)), sub(0, getFieldData_byte(0x18, loadMemoryWord(20))), getFieldData_byte(0x20, loadMemoryWord(20))))
            writeOutput(bezierVertex(sub(0, slot1), slot0, sub(0, mload(add(pVars, 0xa0))), slot2, sub(0, getFieldData_byte(0x08, loadMemoryWord(20))), getFieldData_sub_bits(30, 8, 0x10, loadMemoryWord(20))))
            writeOutput(bezierVertex(sub(0, mload(add(pVars, 0x0200))), mload(add(pVars, 0x01e0)), sub(0, mload(add(pVars, 0x0220))), getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20)), sub(0, 0), getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20))))
            writeOutput_text(4640)
            writeOutput_int(ternary(getFieldData_bitFlag(0x01, loadMemoryWord(29)), 0, 0x01))
            writeOutput_text(4765)
            mstore(add(pVars, 0x0120), add(getFieldData_sub_bits(13, 8, 0x40, loadMemoryWord(22)), 0x25))
            writeOutput_int(add(mload(add(pVars, 0x0120)), 0x3c))
            writeOutput_text(4810)
            writeOutput_int(ternary(getFieldData_bitFlag(0x04, loadMemoryWord(29)), 0, 0x01))
            writeOutput_text(4846)
            writeOutput_int(mload(add(pVars, 0x0120)))
            writeOutput_text(4957)
            slot0 := add(mload(add(pVars, 0x0120)), 0x64)
            writeOutput_int(slot0)
            writeOutput_text(4964)
            writeOutput_int(slot0)
            writeOutput_text(3213)
            writeOutput_int(ternary(getFieldData_bitFlag(0x05, loadMemoryWord(29)), 0, 0x01))
            writeOutput_text(4970)
            slot0 := add(mload(add(pVars, 0x0120)), 0x06)
            writeOutput_int(slot0)
            writeOutput_text(5016)
            writeOutput_int(slot0)
            writeOutput_text(5080)
            writeOutput_int(ternary(getFieldData_bitFlag(0x06, loadMemoryWord(29)), 0, 0x01))
            writeOutput_text(5116)
            writeOutput(vertex(mload(add(pVars, 0x01c0)), mload(add(pVars, 0x01a0))))
            ...
            writeOutput_text(5150)
            writeOutput_int(ternary(getFieldData_bitFlag(0x07, loadMemoryWord(29)), 0, 0x01))
            writeOutput_text(5180)
            writeOutput_int(sub(getFieldData_byte(0x08, loadMemoryWord(22)), 0x48))
            writeOutput_text(5227)
            writeOutput_int(ternary(getFieldData_bitFlag(0x03, loadMemoryWord(29)), 0, 0x01))
            writeOutput_text(5264)
            slot0 := add(mload(add(pVars, 0x0120)), 0x05)
            writeOutput_int(slot0)
            writeOutput_text(5378)
            writeOutput_int(slot0)
            writeOutput_text(2710)
            slot1 := lerp_100(0x28, 0x0a, getFieldData_byte(0x50, loadMemoryWord(20)))
            writeOutput_int(slot1)
            writeOutput_text(2708)
            ...
            writeOutput_int(slot0)
            writeOutput_text(3213)
            writeOutput_int(ternary(getFieldData_bitFlag(0x02, loadMemoryWord(29)), 0, 0x01))
            writeOutput_text(5383)
            slot0 := add(mload(add(pVars, 0x0120)), 0x05)
            writeOutput_int(slot0)
            writeOutput_text(5378)
            writeOutput_int(slot0)
            writeOutput_text(3213)
            writeOutput_int(ternary(getFieldData_bitFlag(0x00, loadMemoryWord(29)), 0, 0x01))
            writeOutput_text(5501)
            writeOutput_int(getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20)))
            writeOutput_text(5546)
            slot0 := sub(getFieldData_byte(0x08, loadMemoryWord(22)), 0x32)
            writeOutput_int(slot0)
            writeOutput_text(5611)
            writeOutput_int(slot0)
            writeOutput_text(5675)
            slot0 := not(sgt(getRvsValue(0x0f), getBreedData_b_tabbyFaceOdds(mload(add(pVars, 0x0280)))))
            writeOutput_int(ternary(slot0, 0, 0x01))
            writeOutput_text(5718)
            writeOutput_int(sub(0, add(getFieldData_byte(0x18, loadMemoryWord(20)), 0x1e)))
            writeOutput_text(2708)
            writeOutput_int(sub(getFieldData_byte(0x20, loadMemoryWord(20)), 0x05))
            writeOutput_text(5773)
            writeOutput_int(ternary(slot0, 0, 0x01))
            writeOutput_text(6121)
            writeOutput_int(sub(getFieldData_sub_bits(55, 8, 0x00, loadMemoryWord(20)), 0x1e))
            writeOutput_text(6180)
            writeOutput_int(getFieldData_byte(0x00, loadMemoryWord(22)))
            writeOutput_text(2708)
            writeOutput_int(getFieldData_byte(0x08, loadMemoryWord(22)))
            writeOutput_text(6363)
            writeOutput_int(getFieldData_byte(0x00, loadMemoryWord(22)))
            writeOutput_text(6377)
            writeOutput_int(getFieldData_byte(0x08, loadMemoryWord(22)))
            writeOutput_text(6380)
            writeOutput_int(getFieldData_byte(0x00, loadMemoryWord(22)))
            writeOutput_text(2708)
            writeOutput_int(getFieldData_byte(0x08, loadMemoryWord(22)))
            writeOutput_text(6470)
            writeOutput_int(sdiv(mul(mul(mul(0x64, 0xb4), 0x013a), getFieldData_sub_bits(64, 8, 0x28, loadMemoryWord(22))), 0x64))
            writeOutput_text(6491)
            slot0 := sub(0, getFieldData_byte(0x10, loadMemoryWord(22)))
            mstore(add(pVars, 0xc0), vertex(sub(slot0, 0), 0))
            writeOutput(mload(add(pVars, 0xc0)))
            mstore(add(pVars, 0xe0), lerp_100(sub(0, getFieldData_sub_bits(3, 8, 0x18, loadMemoryWord(22))), getFieldData_byte(0x20, loadMemoryWord(22)), mul(0, 0x64)))
            ...
            mstore(add(pVars, 0x01a0), sdiv(mul(0x32, getFieldData_byte(0x10, loadMemoryWord(22))), 0x64))
            slot4 := bezierVertex(mload(add(pVars, 0x01a0)), mload(add(pVars, 0xe0)), getFieldData_byte(0x10, loadMemoryWord(22)), sdiv(mul(0x32, mload(add(pVars, 0xe0))), 0x64), add(getFieldData_byte(0x10, loadMemoryWord(22)), 0x04), 0)
            writeOutput(slot4)
            slot1 := lerp_100(getFieldData_byte(0x20, loadMemoryWord(22)), sub(0, getFieldData_sub_bits(3, 8, 0x18, loadMemoryWord(22))), mul(0, 0x64))
            mstore(add(pVars, 0x0180), sdiv(mul(0x32, slot1), 0x64))
            mstore(add(pVars, 0x0160), sdiv(mul(0x32, getFieldData_byte(0x10, loadMemoryWord(22))), 0x64))
            slot3 := bezierVertex(getFieldData_byte(0x10, loadMemoryWord(22)), mload(add(pVars, 0x0180)), mload(add(pVars, 0x0160)), slot1, 0, slot1)
            writeOutput(slot3)
            ...
            writeOutput(slot2)
            writeOutput_text(6498)
            writeOutput(mload(add(pVars, 0xc0)))
            writeOutput_text(6610)
            writeOutput(mload(add(pVars, 0xa0)))
            writeOutput_text(6610)
            writeOutput(slot4)
            writeOutput_text(6610)
            ...
            writeOutput_text(6610)
            writeOutput(bezierVertex(slot0, sdiv(getFieldData_byte(0x20, loadMemoryWord(22)), 0x02), mload(add(pVars, 0x01c0)), sdiv(getFieldData_byte(0x20, loadMemoryWord(22)), 0x01), 0, sdiv(getFieldData_byte(0x20, loadMemoryWord(22)), 0x01)))
            writeOutput_text(6610)
            writeOutput(bezierVertex(mload(add(pVars, 0x01a0)), sdiv(getFieldData_byte(0x20, loadMemoryWord(22)), 0x01), getFieldData_byte(0x10, loadMemoryWord(22)), sdiv(getFieldData_byte(0x20, loadMemoryWord(22)), 0x02), add(getFieldData_byte(0x10, loadMemoryWord(22)), 0x04), 0))
            writeOutput_text(6610)
            writeOutput(bezierVertex(getFieldData_byte(0x10, loadMemoryWord(22)), mload(add(pVars, 0x0180)), mload(add(pVars, 0x0160)), slot1, 0, slot1))
            writeOutput_text(6610)
            ...
            writeOutput_text(6610)
            writeOutput(slot2)
            writeOutput_text(6617)
            writeOutput_int(getFieldData_byte(0x00, loadMemoryWord(22)))
            writeOutput_text(2708)
            writeOutput_int(getFieldData_byte(0x08, loadMemoryWord(22)))
            writeOutput_text(6786)
            writeOutput_int(getFieldData_sub_bits(8, 8, 0x30, loadMemoryWord(22)))
            writeOutput_text(6838)
            writeOutput_int(getFieldData_sub_bits(8, 8, 0x38, loadMemoryWord(22)))
            writeOutput_text(6845)
            writeOutput_int(sdiv(getFieldData_byte(0x00, loadMemoryWord(23)), 0x02))
            writeOutput_text(6852)
            writeOutput_int(sdiv(getFieldData_byte(0x08, loadMemoryWord(23)), 0x02))
            writeOutput_text(6859)
            writeOutput_int(sdiv(add(add(getFieldData_byte(0x10, loadMemoryWord(22)), getFieldData_sub_bits(8, 8, 0x30, loadMemoryWord(22))), 0), 0x03))
            writeOutput_text(2708)
            writeOutput_int(sdiv(add(mload(add(pVars, 0xe0)), add(getFieldData_sub_bits(8, 8, 0x38, loadMemoryWord(22)), 0)), 0x03))
            writeOutput_text(6991)
            writeOutput_int(sdiv(add(slot0, add(getFieldData_sub_bits(8, 8, 0x30, loadMemoryWord(22)), 0)), 0x03))
            writeOutput_text(2708)
            writeOutput_int(sdiv(add(add(slot1, getFieldData_sub_bits(8, 8, 0x38, loadMemoryWord(22))), 0), 0x03))
            writeOutput_text(7103)
            writeOutput_int(getFieldData_byte(0x00, loadMemoryWord(22)))
            writeOutput_text(2708)
            writeOutput_int(getFieldData_byte(0x08, loadMemoryWord(22)))
            writeOutput_text(7326)
            writeOutput_int(getFieldData_byte(0x00, loadMemoryWord(22)))
            writeOutput_text(6377)
            writeOutput_int(getFieldData_byte(0x08, loadMemoryWord(22)))
            writeOutput_text(7339)
            writeOutput_int(getFieldData_byte(0x00, loadMemoryWord(22)))
            writeOutput_text(2708)
            writeOutput_int(getFieldData_byte(0x08, loadMemoryWord(22)))
            writeOutput_text(7535)
            writeOutput_int(mload(add(pVars, 0x0120)))
            writeOutput_text(7665)
            slot2 := constrain(add(mload(add(pVars, 0x0120)), getFieldData_byte(0x00, loadMemoryWord(24))), mload(add(pVars, 0x0120)), getFieldData_byte(0x28, loadMemoryWord(20)))
            writeOutput(line(0, sub(mload(add(pVars, 0x0120)), mload(add(pVars, 0x0120))), 0, sub(slot2, mload(add(pVars, 0x0120)))))
            writeOutput_text(7790)
            slot0 := constrain(add(slot2, getFieldData_sub_bits(2, 8, 0x10, loadMemoryWord(24))), mload(add(pVars, 0x0120)), getFieldData_byte(0x28, loadMemoryWord(20)))
            slot3 := sub(average(0, getFieldData_byte(0x08, loadMemoryWord(24))), sdiv(mul(getFieldData_sub_bits(17, 8, 0x18, loadMemoryWord(24)), sub(slot0, slot2)), 0x64))
            slot1 := add(average(slot2, slot0), sdiv(mul(getFieldData_sub_bits(17, 8, 0x18, loadMemoryWord(24)), sub(getFieldData_byte(0x08, loadMemoryWord(24)), 0)), 0x64))
            writeOutput_bezier(0, sub(slot2, mload(add(pVars, 0x0120))), average(0, slot3), sub(average(slot2, slot1), mload(add(pVars, 0x0120))), average(getFieldData_byte(0x08, loadMemoryWord(24)), slot3), sub(average(slot0, slot1), mload(add(pVars, 0x0120))), getFieldData_byte(0x08, loadMemoryWord(24)), sub(slot0, mload(add(pVars, 0x0120))))
            writeOutput_text(7864)
            writeOutput_int(ternary(getBreedData_f_whiskers(mload(add(pVars, 0x0280))), 0, 0x01))
            writeOutput_text(7928)
            writeOutput_int(sdiv(mul(sub(0, getFieldData_byte(0x10, loadMemoryWord(25))), 0x05), 0x0a))
            writeOutput_text(2708)
            writeOutput_int(getFieldData_byte(0x18, loadMemoryWord(25)))
            writeOutput_text(7991)
            writeOutput_int(sub(0, 0x11))
            writeOutput_text(6491)
            slot2 := sdiv(mul(0x96, getFieldData_byte(0x10, loadMemoryWord(25))), 0x64)
            slot0 := add(average(slot2, getFieldData_byte(0x20, loadMemoryWord(25))), sdiv(mul(getFieldData_sub_bits(18, 8, 0x30, loadMemoryWord(25)), sub(getFieldData_byte(0x28, loadMemoryWord(25)), 0)), 0x64))
            slot1 := sub(average(0, getFieldData_byte(0x28, loadMemoryWord(25))), sdiv(mul(getFieldData_sub_bits(18, 8, 0x30, loadMemoryWord(25)), sub(getFieldData_byte(0x20, loadMemoryWord(25)), slot2)), 0x64))
            mstore(add(pVars, 0xa0), average(slot2, slot0))
            slot4 := average(0, slot1)
            slot3 := average(getFieldData_byte(0x20, loadMemoryWord(25)), slot0)
            slot0 := average(getFieldData_byte(0x28, loadMemoryWord(25)), slot1)
            writeOutput_bezier(slot2, 0, mload(add(pVars, 0xa0)), slot4, slot3, slot0, getFieldData_byte(0x20, loadMemoryWord(25)), getFieldData_byte(0x28, loadMemoryWord(25)))
            writeOutput_text(8071)
            writeOutput_int(sub(0, add(sdiv(mul(mul(0x39, 0x02), getFieldData_byte(0x08, loadMemoryWord(25))), 0x64), 0x11)))
            writeOutput_text(6491)
            writeOutput_bezier(slot2, 0, mload(add(pVars, 0xa0)), slot4, sdiv(mul(slot3, 0x09), 0x0a), slot0, sdiv(mul(getFieldData_byte(0x20, loadMemoryWord(25)), 0x09), 0x0a), getFieldData_byte(0x28, loadMemoryWord(25)))
            writeOutput_text(8151)
            writeOutput_int(ternary(sgt(getFieldData_byte(0x00, loadMemoryWord(25)), 0x02), 0, 0x01))
            writeOutput_text(8222)
            writeOutput_int(sub(0, add(sdiv(mul(mul(0x39, 0x01), getFieldData_byte(0x08, loadMemoryWord(25))), 0x64), 0x11)))
            writeOutput_text(6491)
            writeOutput_bezier(slot2, 0, mload(add(pVars, 0xa0)), slot4, slot3, slot0, getFieldData_byte(0x20, loadMemoryWord(25)), getFieldData_byte(0x28, loadMemoryWord(25)))
            writeOutput_text(8151)
            writeOutput_int(ternary(sgt(getFieldData_byte(0x00, loadMemoryWord(25)), 0x03), 0, 0x01))
            writeOutput_text(8222)
            writeOutput_int(sub(0, add(sdiv(mul(mul(0x39, 0x03), getFieldData_byte(0x08, loadMemoryWord(25))), 0x64), 0x11)))
            writeOutput_text(6491)
            writeOutput_bezier(slot2, 0, mload(add(pVars, 0xa0)), slot4, sdiv(mul(slot3, 0x4b), 0x64), slot0, sdiv(mul(getFieldData_byte(0x20, loadMemoryWord(25)), 0x4b), 0x64), getFieldData_byte(0x28, loadMemoryWord(25)))
            writeOutput_text(8243)
