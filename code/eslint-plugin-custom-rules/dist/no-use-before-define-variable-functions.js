...
exports.createRule = experimental_utils_1.ESLintUtils.RuleCreator(name => `no-use-before-define-variable-functions`);
...
exports.rule_noUseBeforeDefiveVaruableFunctions = exports.createRule({
