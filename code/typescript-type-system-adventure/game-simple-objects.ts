...
const inFrontOfHouse = {
    ...
    openMailbox: () => ({
         ...
         */
        look: () => inFrontOfHouse.openMailbox(),
        ...
        openEnvelop: () => ({
             ...
             */
            look: () => inFrontOfHouse.openMailbox().openEnvelop(),
            ...
            readLetter: () => ({
                 ...
                 */
                look: () => inFrontOfHouse.openMailbox().openEnvelop().readLetter(),
...
const play = () => {
    ...
    gameStart
        ...
        .knockOnDoor().wait().eatCookie().youAreNowBeingTracked().win()
        ;
