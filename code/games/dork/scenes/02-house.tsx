...
export const createScene_02house = (gameState: GameState) => {
    const {
        triggerGameOver,
        inventory,
        removeFromInventory,
    ...
    const gameScene: GameScene = {
        ...
        You are standing outside a large house.
        `,
        execute,
        getLookItems: () => [
            // mailbox,
...
export type Scene02House = ReturnType<typeof createScene_02house>;
