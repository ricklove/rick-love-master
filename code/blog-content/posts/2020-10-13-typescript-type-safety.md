...
![](2020-10-13-throw-baby.gif)

(Bonus points if you are old enough to get that reference.)
...
// Don't ever do this - this is garbage
...
export const butYouShould = () => {
    ...
    // With 'noImplicitAny' defined, this would be an error:
    iDontCare((whatever) => {
